	soc_system u0 (
		...
		.spi_port_sclk                         (<connected-to-spi_port_sclk>),                         //                  spi_port.sclk
		.spi_port_tx                           (<connected-to-spi_port_tx>),                           //                          .tx
		.spi_port_rx                           (<connected-to-spi_port_rx>),                           //                          .rx
		.spi_port_cs0                          (<connected-to-spi_port_cs0>),                          //                          .cs0
		.spi_port_cs1                          (<connected-to-spi_port_cs1>),                          //                          .cs1
		.spi_port_cs2                          (<connected-to-spi_port_cs2>),                          //                          .cs2
		.spi_port_cs3                          (<connected-to-spi_port_cs3>)                           //                          .cs3
	);
